...
@CucumberOptions(
		...
		monochrome= true,
		tags = {"~@Ignore"},
		format ={ "pretty","html:target/cucumber-reports/cucumber-pretty","json:target/cucumber-reports/CucumberTestReport.json","json:target/cucumber-reports/CucumberTestReport.html",
